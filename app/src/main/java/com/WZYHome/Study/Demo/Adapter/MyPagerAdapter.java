...
public class MyPagerAdapter extends PagerAdapter {
    ...
    public MyPagerAdapter(Context context, ArrayList<News> newsArrayList ,CallBack callBack1) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        imageView.setImageResource(mNewsArrayList.get(position).getResId());
        textView.setText(mNewsArrayList.get(position).getTitle());
