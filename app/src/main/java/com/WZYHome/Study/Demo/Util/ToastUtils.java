...
public class ToastUtils {
     ...
     * @param text 文本
     */
    public static void showShortHintToast(CharSequence text) {
        showToast(text + "!", Toast.LENGTH_SHORT);
    }
     ...
     * @param text 文本
     */
    public static void showLongHintToast(CharSequence text) {
        showToast(text + "!", Toast.LENGTH_LONG);
    }
...
//    }
    ...
    private static void showToast(CharSequence text, int duration) {
        //加载Toast布局
        View toastRoot = LayoutInflater.from(Utils.getContext()).inflate(R.layout.base_toast, null);
        TextView txtMessage = null;
        //初始化布局控件
        txtMessage = (TextView) toastRoot.findViewById(R.id.txtMessage);
        ...
        sToast.setGravity(Gravity.BOTTOM, 0, height / 4);
        sToast.show();
    }
