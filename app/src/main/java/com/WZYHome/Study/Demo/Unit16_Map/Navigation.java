 ...
 * <uses-permission android:name="android.permission.RECORD_AUDIO"/>
 ...
 <activity
 android:name=".Unit16_Map.Navigation"
...
public class Navigation extends Activity implements View.OnClickListener
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ActivityCompat.checkSelfPermission(Navigation.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
